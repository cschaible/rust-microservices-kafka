...
pub const B3_PARENT_SPAN_ID_HEADER: &str = "x-b3-parentspanid";
...
impl Propagator {
    ...
    pub fn extract_trace_id(&self, trace_id: &str) -> Result<TraceId, ()> {
    ...
    #[allow(clippy::result_unit_err)]
    pub fn extract_span_id(&self, span_id: &str) -> Result<SpanId, ()> {
        // Only allow lower case hex string
    ...
    #[allow(clippy::result_unit_err)]
    pub fn extract_debug_flag(&self, debug: &str) -> Result<TraceFlags, ()> {
        match debug {
    ...
    #[allow(clippy::result_unit_err)]
    pub fn extract_single_header(&self, extractor: &dyn Extractor) -> Result<SpanContext, ()> {
    ...
    #[allow(clippy::result_unit_err)]
    pub fn extract_multi_header(&self, extractor: &dyn Extractor) -> Result<SpanContext, ()> {
        let trace_id = self
